...
Sistem Autentikasi: Pengguna dapat melakukan Register dan Login.
Manajemen Makanan (CRUD): Pengguna dapat menambahkan, melihat, mengubah, dan menghapus data makanan.
Sistem Status Makanan: Menentukan status Masih Segar, Segera Digunakan, atau Melewati Batas berdasarkan tanggal penggunaan.
Sistem Prioritas: Mengurutkan makanan berdasarkan batas penggunaan.
Detail Makanan: Menampilkan informasi lengkap makanan seperti nama, kategori, jumlah, tanggal disimpan, batas penggunaan, dan lokasi penyimpanan.

Catatan: Status hanya berdasarkan tanggal yang dimasukkan pengguna dan bukan penilaian keamanan makanan.

5. Fitur yang Tidak Dikerjakan (Out of Scope)
AI & Kamera: Tidak menentukan kondisi atau keamanan makanan menggunakan AI/kamera.
...
Autentikasi Berhasil: Pengguna dapat Register/Login dan mengakses data miliknya.
